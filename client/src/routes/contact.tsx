      ...
      <section className="mx-auto grid max-w-5xl gap-12 px-6 py-24 md:grid-cols-2">
        <div>
          ...
          <h1 className="mt-3 font-display text-5xl tracking-tight text-ink">
            Say <span className="italic text-muted-foreground">hello.</span>
          </h1>
          ...
          <div className="mt-8 space-y-3 text-sm">
            <a
              href="mailto:hello@opensource-scout.dev"
        ...
        >
          ...
          <input
            required
            className="mt-1 h-11 w-full rounded-xl border border-border bg-secondary/60 px-3 outline-none focus:border-[var(--color-accent)] focus:bg-surface"
          />
          ...
          <textarea
            rows={5}
            required
            className="mt-1 w-full rounded-xl border border-border bg-secondary/60 p-3 outline-none focus:border-[var(--color-accent)] focus:bg-surface"
          />
